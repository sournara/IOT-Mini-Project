...
int main(int argc, char *argv[])
{
		...
		CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","SNR_SQL","PASSWD"}, \
				{0,-1,"","SNR_UBT","PASSWD"},  {0,-1,"","SNR_ARD","PASSWD"}, \
				{0,-1,"","SNR_AND","PASSWD"},  {0,-1,"","SNR_LIN","PASSWD"}, \
				{0,-1,"","SNR_BT","PASSWD"},  {0,-1,"","SNR_BTT","PASSWD"}, \
